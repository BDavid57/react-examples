...
export const BlaBla = () => {
  console.log('Blabla component re-rendered')
  return <StyledDiv>Some random stuff</StyledDiv>
};

// Another component that renders a div with different text content
export const AdditionalComplexThings = () => {
  console.log('Additional component re-rendered')

  return <AdditionalStyle>Additional complex stuff</AdditionalStyle>
};
